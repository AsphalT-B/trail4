...
export function Hero({ featuredVideo }: { featuredVideo?: Video }) {
    ...
    return (
        <section className="relative overflow-hidden border-b border-line bg-gradient-to-b from-indigo-50 to-white">
            <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 pt-16 pb-12 sm:px-6 sm:pb-16 md:pt-24 md:pb-20">
                ...
                <div className="relative mx-auto h-72 w-72 sm:h-80 sm:w-80">
                    ...
                    <div className="animate-float absolute left-2 top-4 hidden h-20 w-20 items-center justify-center rounded-2xl bg-primary text-white shadow-xl shadow-primary/30 sm:flex">
                        <Code2 className="h-9 w-9" />
                    </div>
                    <div className="animate-float-reverse absolute right-0 top-16 hidden h-16 w-16 items-center justify-center rounded-full bg-accent text-white shadow-xl shadow-accent/30 sm:flex">
                        <Award className="h-7 w-7" />
                    </div>
                    <div className="animate-float absolute bottom-8 left-10 hidden h-24 w-24 items-center justify-center rounded-3xl bg-white text-primary shadow-xl [animation-delay:1.2s] sm:flex">
                        <BookOpen className="h-10 w-10" />
                    </div>
                    <div className="animate-float-reverse absolute bottom-0 right-6 hidden h-14 w-14 items-center justify-center rounded-full bg-ink text-white shadow-xl [animation-delay:0.6s] sm:flex">
